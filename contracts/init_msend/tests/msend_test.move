...
module init_msend::msend_test {
    ...
    public fun mint_mtokens() {
        ...
        let send = coin::mint_for_testing<SEND>(100_000_000_000 * 1_000_000, scenario.ctx());
        let treasury_cap: TreasuryCap<MSEND> = coin::create_treasury_cap_for_testing(scenario.ctx());
