...
export class Char implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: CharFields, ) { this.$fullTypeName = composeSuiType( Char.$typeName, ...typeArgs ) as `${typeof PKG_V11}::ascii::Char`; this.$typeArgs = typeArgs;
...
export class String implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: StringFields, ) { this.$fullTypeName = composeSuiType( String.$typeName, ...typeArgs ) as `${typeof PKG_V11}::ascii::String`; this.$typeArgs = typeArgs;
