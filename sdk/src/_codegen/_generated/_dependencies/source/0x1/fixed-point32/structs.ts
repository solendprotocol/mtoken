...
export class FixedPoint32 implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: FixedPoint32Fields, ) { this.$fullTypeName = composeSuiType( FixedPoint32.$typeName, ...typeArgs ) as `${typeof PKG_V11}::fixed_point32::FixedPoint32`; this.$typeArgs = typeArgs;
