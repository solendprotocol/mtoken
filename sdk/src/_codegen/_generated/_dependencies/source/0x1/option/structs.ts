...
; readonly $typeName = Option.$typeName; readonly $fullTypeName: `${typeof PKG_V11}::option::Option<${ToTypeStr<Element>}>`; readonly $typeArgs: [ToTypeStr<Element>]; readonly $isPhantom = Option.$isPhantom;
 ...
 private constructor(typeArgs: [ToTypeStr<Element>], fields: OptionFields<Element>, ) { this.$fullTypeName = composeSuiType( Option.$typeName, ...typeArgs ) as `${typeof PKG_V11}::option::Option<${ToTypeStr<Element>}>`; this.$typeArgs = typeArgs;
