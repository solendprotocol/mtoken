...
export class String implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: StringFields, ) { this.$fullTypeName = composeSuiType( String.$typeName, ...typeArgs ) as `${typeof PKG_V11}::string::String`; this.$typeArgs = typeArgs;
